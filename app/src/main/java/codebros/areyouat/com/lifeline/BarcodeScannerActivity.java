...
public class BarcodeScannerActivity extends AppCompatActivity {
    ...
    public Button mBarcodeScanButton;
    ...
    private void processAndSetImage() {
        ...
        mBarcodeScanButton.setVisibility(View.GONE);
        ...
        if(!detector.isOperational()){
            Toast.makeText(this, "Could not setup the detector.", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        Log.d("Barcode", thisCode.displayValue);
